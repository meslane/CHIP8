 888  8   8  88888  8888           888
8     8   8    8    8   8         8   8
8     88888    8    8888   88888   888
8     8   8    8    8             8   8
 888  8   8  88888  8              888
...
It does not (currently) provide support for CHIP-8 extendions such as Super Chip-48.
...
Next, you will be prompted to input a delay value. This controls how long the game idles after each cycle.
Most games are only playable with a delay value of around 2000+, but some demos may need to run faster.
Finally, you must specify if you want the emulator to wrap around out of bound sprites. This varies from game to game.
